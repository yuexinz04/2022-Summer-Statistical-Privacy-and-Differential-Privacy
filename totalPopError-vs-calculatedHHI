...
pa_race_graph <- plot_statePop_vs_hhi("42", "Pennsylvania")
nc_race_graph <- plot_statePop_vs_hhi("37", "North Carolina")
sc_race_graph <- plot_statePop_vs_hhi("45", "South Carolina")
la_race_graph <- plot_statePop_vs_hhi("22", "Louisiana")
al_race_graph <- plot_statePop_vs_hhi("1", "Alabama")
de_race_graph <- plot_statePop_vs_hhi("10", "Delaware")
ut_race_graph <- plot_statePop_vs_hhi("49", "Utah")
wa_race_graph <- plot_statePop_vs_hhi("53", "Washington")
